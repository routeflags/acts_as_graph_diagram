...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'Summary of ActsAsGraphDiagram.'
  spec.description = 'Description of ActsAsGraphDiagram.'
  spec.license     = 'MIT'
  ...
  spec.metadata['changelog_uri'] = 'https://github.com/smapira/acts_as_graph_diagram/blob/master/Changelog.md'
